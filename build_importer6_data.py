#!/usr/bin/env python3
"""ساخت data/articles.json برای QPedia Importer 4 — فقط به‌روزرسانی لینک (۵ مقاله).
...
اجرا:  python3 build_importer6_data.py
"""
import json
import os

SRC = "articles-new"
OUT = "qpedia-importer-6/data/articles.json"
BASE = "qpedia-importer-3/data/articles.json"   # فقط برای برداشتن دسته‌بندی‌ها

# ۸ مقالهٔ از قبل منتشرشده که لینک دانشمند گرفتند و باید به‌روز شوند
PACK = [
    "q-day",
    "nobel-physics-2025",
