...
<body <?php body_class(); ?>>
<?php wp_body_open(); ?>
<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'پرش به محتوا', 'quantum-pedia-child' ); ?></a>
...
<header id="masthead" class="qp-global-header">
	<div class="container qp-global-header__inner">
		...
		<nav class="qp-desktop-nav" aria-label="<?php esc_attr_e( 'دسته‌های کوانتوم', 'quantum-pedia-child' ); ?>">
